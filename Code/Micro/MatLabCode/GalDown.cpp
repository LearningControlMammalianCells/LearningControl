/* 
 ...
 This script moves DOWN galactose syringe and, moves UP glucose syringe
 Motor1 -> TL2 -> Galactose 
 Motor2 -> TL1 -> Glucose 
 TL2 and TL1 are the ports on the stepperBee+ board
...
*/
 ...
 if(HStpDll!=NULL)
	...
	Type_InitStp InitStp = (Type_InitStp)GetProcAddress( HStpDll, "InitStp");
	    ...
	    RunMotor2(StepNumber,StepInterval,1,0); 
        RunMotor1(StepNumber,StepInterval,1,0); 
        }
        else{
             cout<<"error";
             }
